...
export default function Home() {
  ...
  // Featured Opportunities shows first 6 needs_funding properties
  ...
  return (
    <Layout>
      ...
      <div className="relative min-h-screen lg:min-h-[90vh] w-full overflow-hidden bg-gradient-to-br from-primary/5 via-white to-amber-50/30">
        ...
        {/* Content */}
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 h-full pt-6 sm:pt-8 lg:pt-12 pb-12 sm:pb-16 lg:pb-20 flex items-center justify-center">
          <div className="flex flex-col items-center text-center w-full max-w-4xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-4 mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100">
            ...
            {/* Stats Row */}
            <div className="grid grid-cols-2 sm:flex sm:flex-nowrap gap-x-12 gap-y-8 sm:gap-12 p-6 sm:p-8 bg-white/50 backdrop-blur-sm rounded-2xl border border-gray-100 w-fit mb-10 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
            ...
            <div className="flex items-center justify-center gap-2 text-gray-600 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-400 whitespace-nowrap overflow-visible">
